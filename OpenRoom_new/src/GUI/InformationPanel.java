...
public class InformationPanel extends javax.swing.JPanel {
	...
	public void initGui() {
		...
		phoneLabel.setFont(new java.awt.Font("微软雅黑",1,14));
		groundPanel.add(userIDLabel);
		userIDLabel.setFont(new java.awt.Font("微软雅黑",1,14));
		groundPanel.add(priceLabel);
		priceLabel.setFont(new java.awt.Font("微软雅黑",1,14));
